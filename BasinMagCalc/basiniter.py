...
imgridZ=np.array(np.cos(np.linspace(0,2*np.pi,100)),np.sin(np.linspace(0,2*np.pi,100)))

# set input/output files
fpout = os.getcwd()+'/600km/mag_output/'
fpin= os.getcwd()+'/600km/'

fpout = r'C:\Users\SteeleSarah\Researches\ImpactCooling\ModelRuns\iSale\Zhurong/'
fpin= r'C:\Users\SteeleSarah\Researches\ImpactCooling\VB\Basins\iSale\d150_v10/'
...
do_basiniter_dual([1800],5,10,15,[0,1,0],'010_200km_ig6',200,imgridZ,fileapp='Cold/',late_remag='excavation')
